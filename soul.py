...
TOKEN =("7872321470:AAGvtsYM7ML2LGmkKblJKYhOsTZAj18DvDg")
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002458866322
CHANNEL_ID = -1002458866322
error_channel_id = -1002458866322
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response += "*For assistance, please contact the owner: @Sarkar3009* "  # Contact owner message
    elif user_data.get('plan', 0) == 0:
        # User found but not approved
        response = "*🔒 Your account is still pending approval!* \n"  # Not approved message
        response += "*Please reach out to the owner for assistance: @Sarkar3009* 🙏"  # Contact owner message
    else:
